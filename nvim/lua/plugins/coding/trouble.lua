...
return {
	{
		...
		keys = {
			...
			{
				"gd",
				"<cmd>lua TagAndGo('Trouble lsp_definitions toggle')<CR>",
				desc = "Go to Definitions",
			},
			{
				"gD",
				"<cmd>lua TagAndGo('Trouble lsp_declarations toggle')<CR>",
				desc = "Go to Declarations",
			},
			{
				"gi",
				"<cmd>lua TagAndGo('Trouble lsp_implementations toggle')<CR>",
				desc = "Go to Implementations",
			},
			{
				"gt",
				"<cmd>lua TagAndGo('Trouble lsp_type_definitions toggle')<CR>",
